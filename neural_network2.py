...
def train_and_evaluate(model, X_train, X_test, y_train, y_test):
    ...
    X_train_split, X_val, y_train_split, y_val = train_test_split(X_train, y_train_num, test_size=0.1, random_state=42)
...
def main():
    ...
    X_train, y_train, X_test, y_test = load_and_preprocess_data(file1, file2)
